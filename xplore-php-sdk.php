...
class XPLORE {
    ...
    /**
     *   @param string $debugMode       If this mode is on (true) then output query and not data
     *   @return mixed $formattedData   Either raw result string, SimpleXML or JSON object, or array
     */
    public function callAPI($debugModeOff=true) {
     ...
     */
    protected function queryAPI($str) {
